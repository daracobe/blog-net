...
using MyBlog.Models;
using static MyBlog.Models.GoogleChartModel;
...
namespace MyBlog.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public ActionResult DownloadViewPDF(string imagePath)
        {

            //Code to get content
            //ViewBag.ImageUri = imagePath;
            return new Rotativa.ViewAsPdf("ViewPDF") { FileName = "TestViewAsPdf.pdf" };
            //  return View("ViewPDF");
